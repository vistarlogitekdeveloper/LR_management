      ...
      child: Padding(
        ...
        child: Wrap(
          ...
          children: [
            ...
            _kv('Driver', '${lr.vehicle.driver} (${lr.vehicle.driverMobile})'),
            _kv('Route', lr.route),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            flex: 2,
            child: Text(item.invoiceNo, style: const TextStyle(fontSize: 11.5)),
          ),
          Expanded(
            flex: 1,
            child: Text(item.asn, style: const TextStyle(fontSize: 11.5)),
          ),
          Expanded(
            flex: 3,
            child: Text(
          ...
          Expanded(
            flex: 1,
            child: Text(
              '${item.packages} ${item.packageType}',
              style: const TextStyle(fontSize: 11.5),
            ),
          ),
          Expanded(
                ...
                children: [
                  if (format.showEwb) ...[
                    ...
                    if (lr.ewb?.expiry != null)
                      Text(
                        'Expiry: ${formatDate(lr.ewb!.expiry!)}',
                        style: const TextStyle(fontSize: 11.5),
                      ),
                    const SizedBox(height: 10),
                  ],
