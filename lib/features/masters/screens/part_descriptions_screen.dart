      ...
      onSave: (values) async {
        try {
          ...
          final pkgId = (pkgLabel == null || pkgLabel == _none)
              ? null
              : packageTypes.where((e) => e.label == pkgLabel).firstOrNull?.id;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MasterPage(
      ...
      onDelete: canEdit
          ...
          : null,
      columns: const ['Name', 'Nature of Goods', 'Default Package', 'Active'],
      rows: [
