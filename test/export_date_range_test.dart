...
LorryReceipt _lr(String number, String date) =>
    LorryReceipt.fromJson({'id': number, 'number': number, 'lr_date': date});
...
void main() {
  ...
  test('both ends of the range are inclusive', () {
    final rows = lrsInExportRange(
      lrs,
      DateTimeRange(start: DateTime(2026, 7, 1), end: DateTime(2026, 7, 31)),
    );
